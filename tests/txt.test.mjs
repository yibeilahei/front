...
const zhHans = encodingsForLocale("zh-Hans").map((c) => c.id);
assert.ok(zhHans.includes("gb18030"));
assert.equal(zhHans[0], "gb18030");
...
assert.equal(defaultEncodingForLanguage("zh-Hans"), "gb18030");
