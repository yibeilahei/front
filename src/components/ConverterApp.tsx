...
export function ConverterApp() {
  ...
  const renderPreviewPage = useCallback(() => {
    ...
    decodeXthPage(book.pages[pageIndex])
      .then((decoded) => {
        // Bail if the book/page changed while decoding (e.g. rapid page turns).
        if (xtchRef.current !== book || pageRef.current !== pageIndex) return;
